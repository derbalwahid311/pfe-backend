...
class Enseignant(models.Model):
     ...
     Etablissement =models.ForeignKey(Etablissement,on_delete=models.CASCADE,default=0)
     Telephone=models.IntegerField(null=True)
     adresse_email = models.EmailField()
...
class Journal(models.Model):
     ...
     Publication =models.ForeignKey(Publication,on_delete=models.CASCADE,default=0)
